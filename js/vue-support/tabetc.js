    ...
    data:
        ...
        function () {
            ...
            return {
                ...
                "tabs": ["Commanding", "Events", "Channels", "Uplink", "Downlink", "Logs", "Setting"],
                "config": config,
                "drawer": null,
                "links": [
                    { icon: "mdi-chevron-double-right", text: "Commanding", key: "commanding" },
                    { icon: "mdi-calendar-blank", text: "Events", key: "events" },
                    { icon: "mdi-card-text-outline", text: "Channels", key: "channels" },
                    { icon: "mdi-satellite-uplink", text: "Uplink", key: "uplink" },
                    { icon: "mdi-satellite-variant", text: "Downlink", key: "downlink" },
                    { icon: "mdi-file-clock-outline", text: "Logs", key: "logs" },
                    { icon: "mdi-palette", text: "Setting", key: "setting" },
                ],
            }
        },
    methods: {
